...
response=$(curl --write-out %{http_code} --silent --output /dev/null https://github.com/game-of-mates/aec-parties-scraper)
...
if [[ "$response" -ne 200 ]] ; then
  printf "game-of-mates/aec-parties-scraper repository has not been created .. trying to create using git creds"
  
  printf "game-of-mates/aec-parties-scraper repository has not been created - to create try using either of these"
...
git remote add origin https://github.com/game-of-mates/aec-parties-scraper.git
